...
while stop != "q":
    ...
    sleep(9)
    check_force_remove_record('com.Psyonix.RL2D', start_time, transport_id)
    check_for_win_death('com.Psyonix.RL2D', start_time, transport_id)
    # check_for_win_death('com.protopop.brightridge', '', test_txt)
    stop = input("stop")
