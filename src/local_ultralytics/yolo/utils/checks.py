...
from local_ultralytics.yolo.utils import (AUTOINSTALL, LOGGER, ONLINE, ROOT, USER_CONFIG_DIR, TryExcept, colorstr, downloads,
...
def check_pip_update_available():
    ...
    if ONLINE and is_pip_package():
        with contextlib.suppress(ConnectionError):
            from local_ultralytics import __version__
