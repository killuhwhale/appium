...
from local_ultralytics import yolo  # noqa
from local_ultralytics.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                                  guess_model_task, nn, yaml_model_load)
from local_ultralytics.yolo.cfg import get_cfg
from local_ultralytics.yolo.engine.exporter import Exporter
from local_ultralytics.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, ROOT, callbacks,
                                    is_git_dir, yaml_load)
from local_ultralytics.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from local_ultralytics.yolo.utils.downloads import GITHUB_ASSET_STEMS
from local_ultralytics.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    def track(self, source=None, stream=False, **kwargs):
        if not hasattr(self.predictor, 'trackers'):
            from local_ultralytics.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from local_ultralytics.yolo.utils.benchmarks import benchmark
