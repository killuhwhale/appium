...
from local_ultralytics.nn.autobackend import check_class_names
from local_ultralytics.nn.modules import C2f, Detect, Segment
from local_ultralytics.nn.tasks import DetectionModel, SegmentationModel
from local_ultralytics.yolo.cfg import get_cfg
from local_ultralytics.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                    get_default_args, yaml_save)
from local_ultralytics.yolo.utils.checks import check_imgsz, check_requirements, check_version
from local_ultralytics.yolo.utils.files import file_size
from local_ultralytics.yolo.utils.ops import Profile
from local_ultralytics.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
