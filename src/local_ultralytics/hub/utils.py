...
from local_ultralytics.yolo.utils import (ENVIRONMENT, LOGGER, ONLINE, RANK, SETTINGS, TESTS_RUNNING, TQDM_BAR_FORMAT,
...
class Traces:
    ...
    def __init__(self):
        ...
        """
        from local_ultralytics.yolo.cfg import MODES, TASKS
