...
# curl https://redirector.gvt1.com/edgedl/android/studio/install/2021.2.1.15/android-studio-2021.2.1.15-cros.deb
...
# <A HREF="https://r3---sn-o097znss.gvt1.com/edgedl/android/studio/install/2021.2.1.15/android-studio-2021.2.1.15-cros.deb?cms_redirect=yes&amp;mh=D\
...
# STUDIO=$(curl https://redirector.gvt1.com/edgedl/android/studio/install/2021.2.1.15/android-studio-2021.2.1.15-cros.deb | grep -o --regexp='https.\
*com')
